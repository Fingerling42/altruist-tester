...
def _batch_device_entry(device_result: dict[str, object]) -> dict[str, object]:
    return {
        ...
        "usb_serial": _device_identity_value(device_result, "usb_serial"),
        "by_id": _device_identity_value(device_result, "by_id"),
        "by_path": _device_identity_value(device_result, "by_path"),
        "identity_conflicts": _device_identity_value(device_result, "conflicts") or [],
